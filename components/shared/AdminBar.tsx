          ...
          <div className="flex items-center gap-4">
            <div
              className={`w-10 h-10 rounded-xl flex items-center justify-center shadow-lg transition-transform group-hover:scale-105 ${
                isSuperadmin
                  ? "bg-heading text-white shadow-heading/20"
              ...
              <div className="flex items-center gap-2 mb-0.5">
                <span
                  className={`w-1.5 h-1.5 rounded-full animate-pulse ${
                    isSuperadmin ? "bg-accent" : "bg-emerald-400"
                  }`}
                />
                <p className="text-[9px] font-black text-muted uppercase tracking-[0.25em] leading-none">
                  Privileged Session
                </p>
              </div>
              <h2
          ...
          <div className="flex items-center gap-2">
            {isOwner && editUrl && (
              <button
                ...
                className="group/btn flex items-center gap-2 px-4 py-2 bg-white/50 border border-border text-heading rounded-xl text-[10px] font-black uppercase tracking-widest hover:border-accent hover:text-accent transition-all shadow-sm active:scale-95"
              >
                <Edit
                  size={14}
                  strokeWidth={3}
            ...
            {dashboardUrl && (
              <button
                ...
                className="group/btn flex items-center gap-2 px-4 py-2 bg-heading text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-slate-800 transition-all shadow-md active:scale-95"
              >
                <LayoutDashboard
                  size={14}
                  strokeWidth={3}
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all active:scale-95 ${
                    showAdminMenu
                      ...
                      : "bg-white border border-border text-accent hover:border-accent/40 shadow-sm"
                  }`}
                >
