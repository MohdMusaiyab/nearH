    ...
    <main className="bg-white min-h-screen">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          <motion.div
            ...
            className="max-w-4xl"
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-badge-bg text-accent text-[10px] font-black uppercase tracking-widest mb-8 border border-accent/10 shadow-sm">
              <ShieldAlert size={14} /> Data Sovereignty Protocol
            </div>
            <h1 className="text-5xl lg:text-8xl font-black text-heading tracking-tighter leading-[0.9] uppercase mb-10">
              Your Health Data, <br />
              <span className="text-accent">
                Under Lock & Key.
              </span>
            </h1>
            <p className="text-muted text-sm font-bold uppercase tracking-widest leading-relaxed border-l-2 border-accent pl-6 max-w-2xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {securityPrinciples.map((item, i) => (
              <motion.div
                key={i}
                whileHover={{ y: -5 }}
                className="p-10 rounded-[3rem] border border-border bg-white shadow-xl shadow-slate-200/20 transition-all"
              >
                <div className="w-14 h-14 bg-heading rounded-2xl flex items-center justify-center mb-8 shadow-lg">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-7">
              <div className="mb-12">
                <p className="text-[10px] font-black text-accent uppercase tracking-[0.3em] mb-4">
                  Access Matrix
                </p>
                <h2 className="text-4xl lg:text-6xl font-black text-heading tracking-tighter uppercase leading-[0.9] mb-6">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div
                    key={i}
                    className="flex items-center justify-between p-6 rounded-2xl bg-slate-50 border border-border group hover:bg-white hover:shadow-xl hover:shadow-slate-100 transition-all"
                  >
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-xl bg-white border border-border flex items-center justify-center text-accent group-hover:bg-accent group-hover:text-white transition-all">
                    ...
                    <span className="text-[9px] font-black uppercase tracking-widest text-muted bg-white px-4 py-2 rounded-lg border border-border group-hover:border-accent/20 transition-all">
                      {row.access}
                    </span>
                  </div>
                ))}
            ...
            <div className="lg:col-span-5 pt-10">
              <motion.div
                ...
                className="bg-heading rounded-[3rem] p-10 lg:p-14 text-white relative overflow-hidden shadow-2xl"
              >
      ...
      <section className="py-24 bg-slate-50 border-t border-border">
        <div className="max-w-3xl mx-auto px-6 lg:px-12 text-center">
          <h2 className="text-3xl lg:text-5xl font-black text-heading tracking-tighter uppercase mb-16 leading-[0.9]">
            Common{" "}
            <span className="text-accent">Protocols.</span>
          </h2>

          <div className="space-y-4 text-left">
            <div className="p-8 rounded-3xl bg-white border border-border hover:border-accent/30 transition-all">
              <h4 className="text-[11px] font-black text-heading uppercase tracking-[0.2em] mb-3">
