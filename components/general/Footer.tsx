        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-1 space-y-8">
            <Link href="/" className="flex items-center gap-3">
              <div className="w-12 h-12 bg-heading rounded-2xl flex items-center justify-center text-white shadow-lg shadow-slate-200">
                <Activity size={24} strokeWidth={2.5} />
              </div>
              <div>
                <span className="text-2xl font-black text-heading tracking-tighter uppercase leading-none block">
                  NearH
                </span>
            ...
            <p className="text-muted text-xs font-bold uppercase tracking-wide leading-relaxed max-w-xs">
          ...
          <div>
            <h4 className="text-[10px] font-black text-heading uppercase tracking-[0.2em] mb-8">
              Public Directory
            </h4>
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center text-accent group-hover:bg-accent group-hover:text-white transition-all shadow-sm">
                  <Mail size={16} />
                </div>
                <div>
...
const FooterLink = ({
  ...
  <li>
    <Link
      href={href}
      className="group flex items-center gap-2 text-muted hover:text-accent transition-all text-xs font-bold uppercase tracking-tight"
    >
